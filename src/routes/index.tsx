...
function Teachers() {
  const items = [
    { name: "Елена Кремнева", role: "Основатель бизнес-школы", note: "Кандидат юридических наук. Выпускница Executive MBA Московской школы управления «Сколково». Бизнес-практик, методолог пересборки моделей.", img: elenaAsset.url },
