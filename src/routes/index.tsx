        ...
        <div className="grid gap-10 lg:grid-cols-[5fr_7fr] lg:gap-16 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-neutral-600">
              Основатель бизнес-школы. Юрист, методолог, преподаватель. Собирает программу из того, что реально работает у региональных собственников.
            </p>
...
const faqCategories: FaqCategory[] = [
  ...
  },
  {
    ...
    tone: "green",
    qa: [
      { q: "Кто ведёт программу?", a: "Елена Кремнева и команда — лучшие представители практики бизнес-историй: действующие предприниматели, методологи и эксперты с опытом в производстве, рознице и услугах. Каждый — признанный практик в своей области, не теоретик." },
      { q: "Как устроен переход между этапами?", a: "Не внедрили — не идём дальше. Пока вы не закрыли этап реальным артефактом внедрения в своём бизнесе, к следующему уровню не переходите. Это жёсткое правило школы: программа двигается со скоростью внедрения, а не со скоростью лекций." },
    ],
  },
  {
